...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Em um minuto, eu te conto',
  headingEm: 'por que mais método não vai resolver.',
  preText: 'Eu explico aqui por que a sua exaustão não se resolve com mais técnica, mais planilha ou mais hábito novo. E qual é a forma assertiva como eu te acompanho na Clínica da Palavra.',
  postText: 'Assista antes de tocar no botão de conversa. Você vai entender se a minha forma de atender faz sentido pra você.',
}
// ════════════════════════════════════════════════════════════════════
