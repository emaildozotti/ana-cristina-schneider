...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'FUNCIONAL POR FORA.',
  h1: 'No limite da exaustão',
  h1Em: 'por dentro.',
  subtitle: 'Psicanálise para quem mantém tudo funcionando perfeitamente no dia a dia mas está esgotado pelo peso da autocobrança.',
  ctaPrimary: 'Quero conversar pelo WhatsApp',
  ctaSecondary: 'ou entenda o que te trouxe até aqui',
}
// ════════════════════════════════════════════════════════════════════
