...
const COPY = {
  ...
  heading: 'Continuar fingindo que está tudo bem é uma escolha. Conversar comigo',
  headingEm: 'também é.',
  subtitle: 'A conversa inicial de 20 minutos pelo WhatsApp é gratuita e sem compromisso.',
